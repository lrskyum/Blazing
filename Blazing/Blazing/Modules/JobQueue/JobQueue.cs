...
public class JobQueue(NpgsqlDataSource connPool, ILogger<JobQueue> logger) : IJobQueue
{
    ...
    private int _concurrentWorkerThreads = 1;
    ...
    private void ActionLoop(int taskNumber)
    {
        var sql = """
                  copy zuora_access_export (
                      ...
                      account_brand__c,
                      rateplancharge_accessfeature__c,
                      rateplancharge_name,
                      rateplancharge_weekdaymask__c,
                      rateplancharge_effectivestartdate,
                      rateplancharge_effectiveenddate,
                      product_name,
                      rateplan_name,
                      productrateplan_id,
                      subscription_id,
                      subscription_ordernumber__c,
                      subscription_status,
                      subscription_name,
                      subscription_createddate,
                      rateplan_id,
